...
export class DigitalcatalogPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,private iab: InAppBrowser, public con:ConstantProvider, public dbService:DbserviceProvider) {
