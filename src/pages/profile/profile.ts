...
export class ProfilePage {
    ...
    share_code()
    {
        ...
        let app_url = "https://apps.apple.com/us/app/orange-pet/id1641473902";
        
        let msg = "Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Orange Pet- Rewards Application.";
