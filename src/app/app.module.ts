import { DiscountVoucherPageModule } from './../pages/discount-voucher/discount-voucher.module';
import { CustomerDetailPageModule } from './../pages/customer-detail/customer-detail.module';
import { CustomerListPageModule } from './../pages/customer-list/customer-list.module';
import { CustomeraddPageModule } from './../pages/customeradd/customeradd.module';
